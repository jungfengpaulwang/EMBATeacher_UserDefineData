...
namespace UserDefineData.ImportExport
{
    public partial class ImportStudentV2 : FISCA.Presentation.Controls.BaseForm, SmartSchool.API.PlugIn.Import.ImportWizard
    {
        ...
        // 儲存教師狀態
        private K12.Data.TeacherRecord.TeacherStatus _StudStatus = K12.Data.TeacherRecord.TeacherStatus.一般;
        ...
        private List<string> _StudentFields = new List<string>(new string[] { "姓名", "暱稱" });
        ...
        private void CheckFile()
        {
            ...
            if (!_ImportFields.ContainsKey("姓名") && !_ImportFields.ContainsKey("暱稱"))
            {
                messingFields += (messingFields == "" ? "" : ",") + "姓名+暱稱";
            }
            if (messingFields != "")
            {
